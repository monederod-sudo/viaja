...
app.use(cors({origin: 'https://cool-cannoli-ff9d94.netlify.app'
}));
...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: 'vqsxhlkqlyykdrzz' // ⚠️ Reemplaza esto con tu contraseña de aplicación de Gmail (16 caracteres)
  }
});
